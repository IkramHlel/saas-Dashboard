  ...
  return (
    <div className={styles.dashboardPage}>
      <div className={styles.cardsGrid}>
        <MetricCard
          titles={['Sales', 'Volume']}
          values={[`₦${stats.sales.toLocaleString()}`, stats.volume]}
          icon={<MdBarChart size={22} color='#1C1D22' />}
        />

        <MetricCard
          titles={['Customers', 'Active']}
          values={[stats.customers, stats.active]}
          icon={<MdPeople size={22} color="#1C1D22" />}
        />

        <MetricCard
          titles={['All Orders', 'Pending', 'Completed']}
          values={[stats.allOrders, stats.pending, stats.completed]}
          ...
          <div className={styles.chartBody}>
            <div className={styles.chartPlaceholder}>
              ...
              <div className={styles.markettingCards}>
                <MetricCard
                 titles={['All Products', 'Active', 'Completed']}
                 values={[stats.allProducts, stats.Active,]}
                 icon={<MdInventory2 size={22} color="#1C1D22" />}
                />
                <MetricCard
               titles={['Abandoned Cart', 'Customers']}
               values={[stats.abandonedCart, stats.customers]}
